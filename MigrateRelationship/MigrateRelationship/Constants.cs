...
namespace MigrateRelationship
{
    class Constants
    {
        ...
        public static readonly string CreateReportTable = "create table ReportTable(ScanJobId varchar(255),JobId varchar(255),ItemId varchar(255),Result varchar(255),Message varchar(255))";
    }
}
